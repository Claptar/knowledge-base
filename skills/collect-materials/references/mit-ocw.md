...
```bash
python3 ../adapt-recordings/scripts/course_inventory.py sources/<slug>      # what is in here
python3 ../adapt-recordings/scripts/organise_course.py  sources/<slug>      # dry run
python3 ../adapt-recordings/scripts/normalise_names.py  sources/<slug>      # dry run
```
