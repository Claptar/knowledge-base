...
[`docs/resources/cme-transcription.md`](../../../docs/resources/cme-transcription.md) — the same
...
catalogue entry. Until then the entry says `unresolved`, conversions go to `reference-private/` and
adaptations to `adapted-private/` — see AGENTS.md, *What may be republished*.
...
[`docs/resources/cme-transcription.md`](../../../docs/resources/cme-transcription.md#pachter-lab-theses--the-same-work-in-long-form).
